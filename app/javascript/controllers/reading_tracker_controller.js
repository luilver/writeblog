...
export default class extends Controller {
  static values = { blogId: Number, leafId: Number }
  ...
  #scrollToLastReadParagraph() {
    const [ leafId, lastReadParagraphIndex ] = getReadingProgress(this.blogIdValue)
  ...
  #storeProgress() {
    storeReadingProgress(this.blogIdValue, this.leafIdValue, this.lastReadParagraphIndex)
  }
}

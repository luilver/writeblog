module TranslationsHelper
  TRANSLATIONS = {
    blog_author: { "🇺🇸": "Author", "🇪🇸": "Autor", "🇫🇷": "Auteur", "🇮🇳": "लेखक", "🇩🇪": "Autor", "🇧🇷": "Autor" },
    blog_subtitle: { "🇺🇸": "Subtitle", "🇪🇸": "Subtítulo", "🇫🇷": "Sous-titre", "🇮🇳": "उपशीर्षक", "🇩🇪": "Untertitel", "🇧🇷": "Subtítulo" },
    blog_title: { "🇺🇸": "Blog title", "🇪🇸": "Título del blog", "🇫🇷": "Titre du blog", "🇮🇳": "ब्लॉग का शीर्षक", "🇩🇪": "Blog titel", "🇧🇷": "Título do blog" },

...
ActiveRecord::Schema[8.0].define(version: 2024_06_25_224312) do
  create_table "accesses", force: :cascade do |t|
    ...
    t.index ["blog_id"], name: "index_accesses_on_blog_id"
    t.index ["user_id", "blog_id"], name: "index_accesses_on_user_id_and_blog_id", unique: true
